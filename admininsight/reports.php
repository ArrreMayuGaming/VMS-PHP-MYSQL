...
if (isset($_POST['date'])) {
    ...
    if (empty($startdate) && empty($enddate)) {
        ...
        $selectQuery = "SELECT * FROM visitorsinfo WHERE passdate BETWEEN '$startdate' AND '$enddate' ORDER BY passdate DESC";
    }
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="superadmin.php" href="javascript:void(0);"><i class="far fa-address-book"></i>Dashboard</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="javascript:void(0);"><i class="fas fa-tachometer-alt"></i>Reports</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0);"><i class="fas fa-user-alt-slash"></i>Logout</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <form method="POST">
            <div class="row">
                <div class="row ml-sm-2">
                    <input placeholder="Starting Date" name="startdate" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" style="margin-left: 1.5em">
                </div>
                <br>
                <p></p>
                ...
                <br>
                <div class="row ml-sm-2">
                    <input placeholder="End Date" name="enddate" class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" style="margin-left: 2em">
                </div>
                <br>
                <div>
        ...
        <div class="col-lg-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="reportdata" class="table table-hover">
                        <thead>
                            <tr>
                                <th><b>NAME</b></th>
                                <th><b>E-MAIL</b></th>
